...
figure('Position', [1, 1, 560, 420 * 1/2]);
...
exportgraphics(Tiles, "../Prefigures/single_all.pdf", 'ContentType', 'vector');
%% lasB Expression

figure('Position', [1, 1, 560, 420 * 1/2]);
LasBTiles = tiledlayout(1, 2);
nexttile(2)
ShowData( ...
...
exportgraphics(Tiles, "../Prefigures/multiple.pdf", 'ContentType', 'vector');

figure('Position', [1, 1, 560, 420 * 1/2]);
LasBTiles2 = tiledlayout(1, 2);
nexttile(2)
ShowData( ...
    readtable("../Models/LasBObservations.csv"), ...
    readtable("../Models/LasBMeans.csv"), ...
...
exportgraphics(LasBTiles2, "../Prefigures/lasb_model.pdf", 'ContentType', 'vector');
...
function ShowData(Observations, Means, Predictions, Options)
    ...
    if ~Options.Both
        ...
        switch Options.Panel
            case "A"
                LegendDimensions = [0.235 * 1.5, 0.37, 0.12 * 1.5, 0.13];
            case "B"
                LegendDimensions = [0.52 * 1.5, 0.34, 0.12 * 1.5, 0.13];
            case "C"
                LegendDimensions = [0.805, 0.39, 0.12, 0.13];
        end
        annotation( ...
            'textbox', LegendDimensions, ...
        ...
        text( ...
            5.25, 4.2, max(Means.mean_expression), ...
            "Maximum", ...
            'FontName', FontName, 'FontSize', SmallFontSize ...
        );
        text( ...
            5.25, 3.35, max(Means.mean_expression), ...
            "Expression", ...
            'FontName', FontName, 'FontSize', SmallFontSize ...
        );
        text( ...
            5.25, 2.5, max(Means.mean_expression), ...
            "with Both", ...
            'FontName', FontName, 'FontSize', SmallFontSize ...
        );
        text( ...
            5.25, 1.65, max(Means.mean_expression), ...
            "AHL Signals", ...
            'FontName', FontName, 'FontSize', SmallFontSize ...
        );
    end
