...
ShowData( ...
    ...
    Gene = "lasI", ...
    Both = false, ...
    LegendDimensions = [0.235 * 1.5, 0.37 + 0.35, 0.12 * 1.5, 0.13 * 0.5] ...
);
nexttile
ShowData( ...
    ...
    Gene = "rhlI", ...
    Both = false, ...
    LegendDimensions = [0.52 * 1.5, 0.34 + 0.35, 0.12 * 1.5, 0.13 * 0.5] ...
);
nexttile
ShowData( ...
    readtable("../Models/LasIObservations.csv"), ...
...
function ShowData(Observations, Means, Predictions, Options)
    ...
    % Panel designation
    title(Options.Panel, 'FontName', FontName, 'FontSize', LargeFontSize, 'FontWeight', "normal");
